...
public class LeetIrc extends javax.swing.JFrame {
	...
	public void initComponents() {
		...
		jLabel2.setIcon(new javax.swing.ImageIcon(this.getClass().getResource(
				"billz.jpg")));
		tabla.add(jLabel2);
		...
		jLabel3.setIcon(new javax.swing.ImageIcon(this.getClass().getResource(
				"fredy_avatar.gif")));
		tabla.add(jLabel3);
		jLabel3.setBounds(300, 200, 70, 110);

		jLabel4.setIcon(new javax.swing.ImageIcon(this.getClass().getResource(
				"nindza.jpg")));
		tabla.add(jLabel4);
		...
		jLabel5.setIcon(new javax.swing.ImageIcon(this.getClass().getResource(
				"lequack01.gif")));
		jPanel5.add(jLabel5);
	...
	public void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton6ActionPerformed
		dde("/say kdor ne gre COD bo tepen tak oda kar res ni, pravi vam "
				+ nick());
